...
def calculate_metrics(df):
    ...
    #df.to_csv('/home/ashwath/Programs/MAGCS/Evaluation/paper2vec_mag_owncontexts_500.tsv', sep='\t')
    df.to_pickle('/home/ashwath/Programs/MAGCS/Pickles/paperwisemetrics_mag_d2v_p2v_owncontexts_may21_df.pickle')
    ...
    mean_series = df.mean()
    mean_series.to_csv('/home/ashwath/Programs/MAGCS/Evaluation/meanmetrics_d2v_p2v_owncontexts_may21.tsv', sep='\t', index=True, header=False)
    print("C'est fini.")
...
df.to_pickle('/home/ashwath/Programs/MAGCS/Pickles/recommendations_p2v_d2v_may22_owncontexts.pickle')

...
papervecs = KeyedVectors.load_word2vec_format('Paper2Vec_mag.txt', binary=False)
...
def calculate_metrics(df):
    ...
    #df.to_csv('/home/ashwath/Programs/MAGCS/Evaluation/paper2vec_mag_citedcontexts_500.tsv', sep='\t')
    df.to_pickle('/home/ashwath/Programs/MAGCS/Pickles/paperwisemetrics_mag_d2v_p2v_citedcontexts_df_may24.pickle')
    ...
    mean_series = df.mean()
    mean_series.to_csv('/home/ashwath/Programs/MAGCS/Evaluation/meanmetrics_d2v_p2v_citedcontexts_may24.tsv', sep='\t', index=True, header=False)
    print("C'est fini.")
...
df.to_pickle('/home/ashwath/Programs/MAGCS/Pickles/recommendations_d2v_p2v_may22.pickle')

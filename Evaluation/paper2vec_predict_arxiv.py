...
papervecs = KeyedVectors.load_word2vec_format('Paper2Vec_arxivmag.txt', binary=False)
...
def calculate_metrics(df):
    ...
    #df.to_csv('/home/ashwath/Programs/ArxivCS/Evaluation/paper2vec_arxivmag_500.tsv', sep='\t')
    df.to_pickle('/home/ashwath/Programs/ArxivCS/Pickles/paperwisemetrics_arxivmag_d2v_df_may21.pickle')
    ...
    mean_series = df.mean()
    mean_series.to_csv('/home/ashwath/Programs/ArxivCS/Evaluation/meanmetrics_d2v_may21.tsv', sep='\t', index=True, header=False)
    print("C'est fini.")
...
df.to_pickle('/home/ashwath/Programs/ArxivCS/Pickles/recommendations_d2v_p2v_binarized_may21.pickle')

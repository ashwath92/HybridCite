...
solr = pysolr.Solr('http://localhost:8983/solr/mag_en_cs_50_all', always_commit=True)
list_for_solr = []
rownum = 0
filename = '/home/ashwath/Programs/MAGCS/AllYearsFiles/mag_cs_50_allyears.txt'

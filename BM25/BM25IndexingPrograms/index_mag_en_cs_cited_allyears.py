...
solr = pysolr.Solr('http://localhost:8983/solr/mag_en_cs_cited_all', always_commit=True)
list_for_solr = []
rownum = 0
filename = '/home/ashwath/Programs/MAGCS/AllYearsFiles/mag_cs_cited_allyears.txt'

...
solr = pysolr.Solr('http://localhost:8983/solr/unpaywallmag_en_cs', always_commit=True)
list_for_solr = []
rownum = 0
filename = '/home/ashwath/Programs/Hyperdoc2vec_fulltext/inputfiles/training_no20182019_with_contexts.txt'

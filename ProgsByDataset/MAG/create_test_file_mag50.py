        ...
        (
            ...
            (
                ...
                (SELECT paperid from paperfieldsofstudy WHERE fieldofstudyid=41008148) AS fieldsofstudy 
                 ON papers.paperid=fieldsofstudy.paperid where papers.publishedyear in (2018,2019) and papers.citationcount>50
...
with open('trainingmagids50.pickle','rb') as pfile:
    allmagpapers_set = pickle.load(pfile)


with open('/home/ashwath/Programs/MAGCS/mag50_testset_contexts.tsv', 'w') as outfile:

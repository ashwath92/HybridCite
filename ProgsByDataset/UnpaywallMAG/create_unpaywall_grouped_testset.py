...
df = df[~df.duplicated()] # 234092 after this.
print(df.shape)
...
grouped_df.to_csv('/home/ashwath/Programs/UnpaywallMAG/inputfiles/unpaywall_testset_contexts_grouped.tsv',
                  sep='\t', encoding='utf-8', index=False, header=None)
print(grouped_df.shape) # (206459, 3)
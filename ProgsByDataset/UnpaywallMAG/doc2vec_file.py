...
class FileTaggedDocument:
    ...
    def __iter__(self):
        for line in tqdm(self.file):
            parts = self.clean_text(line.lower()).split()
            paperid = parts[0]
            content = parts[1:]
...
def main():
    ...
    filename = '/home/ashwath/Programs/UnpaywallMAG/inputfiles/training_no20182019_with_contexts.txt'
    ...
    model.save('UnpaywallMagd2v.dat')
    print('model saved')

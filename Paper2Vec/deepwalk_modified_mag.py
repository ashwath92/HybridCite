...
# Ashwath: changed to use mag, set lockf to 1. and params.
...
def train(model_params):
    ...
    if FLAG_preTrained:
        ...
        print(model.syn0_lockf) # 1 for allowing retraining, 0 for locking it.	
    ...
    model.save('paper2vecmodel_owncontexts.dat')
    return model
...
def main(model_params):
    ...
    model.wv.save_word2vec_format('Paper2Vec_mag.txt', binary=False)
...
if __name__ == '__main__':
    ...
    model_params = {'graph_file': '/home/ashwath/Programs/MAGCS/MAG-CS-Paper2Vec/paperrefs_cs_en_30april.tsv',
                    'num_walks': 10, 'walk_size': 40, 'vec_size': 500, 'window': 5, 
                    'embd_file': '/home/ashwath/Programs/MAGCS/MAG-CS-Paper2Vec/owncontexts_p2v/MAGCompScienced2vOwnContexts.txt'
                    }
    main(model_params)

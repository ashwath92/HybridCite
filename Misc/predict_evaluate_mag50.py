...
def predict(filename):
    ...
    print("Binarized")
    df.to_pickle('/home/ashwath/Programs/MAGCS/Pickles/recommendations_mag50_3models_500_df.pickle')
    df.to_csv('/home/ashwath/Programs/MAGCS/Evaluation/recommendations_mag50_3models_500.tsv', sep='\t')
...
def calculate_metrics(df):
    ...
    for k in tqdm(klist):
        ...
        #print(df)
        df['recall_hd2v_{}'.format(k)] = df[['hd2v_binary', 'ground_truth']].progress_apply(
    ...
    df.to_csv('/home/ashwath/Programs/MAGCS/Evaluation/paperwisemetrics_mag50_3models_500.tsv', sep='\t')
    df.to_pickle('/home/ashwath/Programs/MAGCS/Pickles/paperwisemetrics_mag50_3models_df.pickle')
    print("METRICS CALCULATED, time to calculate the means")
    # Get the mean of all the index columns
    mean_series = df.mean()
    mean_series.to_csv('/home/ashwath/Programs/MAGCS/Evaluation/meanmetrics_mag50.tsv', sep='\t', index=True, header=False)
    print("C'est fini.")

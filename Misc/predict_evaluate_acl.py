...
def predict(filename):
    ...
    print("Binarized")
    df.to_pickle('/home/ashwath/Programs/ACLAAn/Pickles/recommendations_aclmag_3models_500_df.pickle')
    df.to_csv('/home/ashwath/Programs/ACLAAn/Evaluation/recommendations_aclmag_3models_500.tsv', sep='\t')
...
def calculate_metrics(df):
    ...
    df.to_csv('/home/ashwath/Programs/ACLAAn/Evaluation/paperwisemetrics_aclmag_3models_500.tsv', sep='\t')
    df.to_pickle('/home/ashwath/Programs/ACLAAn/Pickles/paperwisemetrics_aclmag_3models_df.pickle')
    print("METRICS CALCULATED, time to calculate the means")
    # Get the mean of all the index columns
    mean_series = df.mean()
    mean_series.to_csv('/home/ashwath/Programs/ACLAAn/Evaluation/meanmetrics.tsv', sep='\t', index=True, header=False)
    print("C'est fini.")
